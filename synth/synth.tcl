...
# #################################CHANGE THIS###################################################
# TOP_LEVEL_NAME
set top_level 			"conv_layer"
# PATH TO YOUR VERILOG NETLIST
set netlist_search_path "/afs/asu.edu/users/k/a/g/kaggar11/conv_verilog/rtl"
# NETLIST NAME
set netlist_name "conv_layer.sv"
# CLOCK PERIOD
set clk_period 			1000
# ################################################################################################
...
write_file -hierarchy -format sverilog -output "./${top_level}.${clk_period}.syn.sv"
# Save current design
