...
#
# Generated by export_simulation on Sun Oct 15 10:33:16 -0700 2023
#
################################################################################
...
'-reset_run' switch to the './tb_conv_layer.sh' script.

./tb_conv_layer.sh -reset_run
...
./tb_conv_layer.sh -noclean_files

For more information on the script, please type './tb_conv_layer.sh -help'.
